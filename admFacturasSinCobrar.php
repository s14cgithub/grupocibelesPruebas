...
session_start(); 
$_SESSION['titulo']="FACTURAS SIN COBRAR";
$ruta="/";
...
<script  src="js/js_facturasSinCobrar.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>
