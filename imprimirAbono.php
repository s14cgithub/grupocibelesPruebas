...
if(isset($_POST["imprimirAccion"]) && $_POST["imprimirAccion"]=="imprimirAbono")
{
	$ruta = '/';
	...
	$numFactura = $_POST["imprimirNumFacturaAbono"];
	$anioSeleccionado = $_POST["imprimirAnioSeleccionado"];
	
	//echo "numero de factura". $numFactura;
	//echo "anio". $anioSeleccionado;
	//$numFactura = "-1"; //el seguiente seguir -2
	//echo $numFactura;
	$datosFactura = verAbono($conexion,$numFactura,$anioSeleccionado);
	$datosDetalles = verAbonoDetalle($conexion,$datosFactura[0]["numero"],$anioSeleccionado);
	
	
	//$nombrePresupuestoCompleto = $datosPresupuesto[0]["presupuesto"]." ".$datosPresupuesto[0]["letra"];
	$nombrePresupuestoCompleto = $datosFactura[0]["factura"];
	...
	$pdf->Cell(35,5,utf8_decode("ABONO Nº"),1,1,'C',false);
	$altura = $altura + 5;
	$pdf->SetXY($margen,$altura);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(35,6,"AB ".$datosFactura[0]["numero"]."/".$datosFactura[0]["fecha"]->format('y'),1,1,'C',false);
	
	$altura = $altura + 6;
	$pdf->SetXY($margen,$altura);
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(35,5,"Rect: ".$datosFactura[0]["factura"],1,1,'C',false);	
	$pdf->SetFont('Arial','',10);
	$altura = $altura + 8;
	$pdf->SetXY($margen,$altura);
	...
	$pdf->SetXY($margen,$altura);
	$pdf->Cell(0,0,"ABONO",0,1,'L',false);
...
Cibeles Mailing S.A. A-81339186"),0,'C',false);*/
	...
	$pdf->Output("I","Abono - ".$numFactura."-".date("dmy")." .pdf","UTF-8");
