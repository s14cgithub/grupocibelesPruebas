...
{	
	...
	//echo '<tr><td>Persona:</td><td colspan="6" id="persona"></td></tr>';
	...
	echo '<tr><td colspan="1">Forma de pago:</td><td colspan="2"> <select name="formaPago" id="formaPago">';
	...
	echo '<tr>
	<td>Neto:</td><td><input type="number" id="Neto" readonly></input></td>
	<td>Iva:</td><td><input type="number" id="iva" readonly></input></td>	
	<td>Total:</td><td><input type="number" id="total" readonly></input></td>	
	</tr>';
	...
	<td>Provision Total:</td><td><input type="number" id="provisionTotal" readonly></td>
	<td>A Pagar:</td><td><input type="number" id="aPagar" readonly></input></td>	
	<td></td><td></td>	
	</tr>';
...
<script  src="js/js_prefacturaMensual.js" type="text/javascript" language="JavaScript" charset="UTF-8"></script>

<script language="javascript">
//verProvisionPrefactura();	
cargarFormasDePago();	
	
verDatosUnaFactura(document.getElementById("numPresupuesto").innerHTML);
