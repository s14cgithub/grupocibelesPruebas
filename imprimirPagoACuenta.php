...
//if(isset($_GET["imprimirAccion"])&$_GET["imprimirAccion"]=="imprimirPresu")
{
	...
	//$numPresupuesto = $_POST["imprimirPagoACuentaNumPresupuesto"];	
	
	$numPresupuesto = $_POST["imprimirPagoACuentaNumPresupuesto"];
	$numPresupuestoContador = $_POST["imprimirPagoACuentaNumPresupuestoContador"];	
...
Cibeles Mailing S.A. A-81339186",0,'C',false);*/
	...
	$pdf->Output("F",rutaPresupuestos.$numPresupuesto." - PagoAcuenta - ".date("dmy").".pdf","UTF-8");	
