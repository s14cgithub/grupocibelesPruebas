...
//date_default_timezone_set('Europe/Madrid');
		...
		/*include($ruta.'clases/datosBD.php');
		include($ruta.'comun/bbdd.php');
		include($ruta.'comun/funciones.php');*/
		...
		<table class="table d-print-none">
			...
			<tr class="miH1">
				...
				<?php 					
					...
					{
						echo ('<button type="button" class="btn btn-secondary" id="cabeceraBotonAtras" aria-haspopup="true" aria-expanded="false"  onclick="location.href = \'administracion.php\';">ir Atras </button>');
					}
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				...
				<div class="form-group">
					<label for="recipient-name" class="col-form-label">Repetir contraseña Nueva:</label>
