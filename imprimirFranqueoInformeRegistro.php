...
if(isset($_POST["imprimirAccion"]) && $_POST["imprimirAccion"]=="imprimirInformeRegistro")
//if(isset($_GET["imprimirAccion"])&$_GET["imprimirAccion"]=="imprimirPresu")
{
	...
	{
		//$contador++;
		if ($clienteAntiguo!=$datos[$contador]["referencia"])
		{
			$clienteAntiguo = $datos[$contador]["referencia"];
			$titulos=array();
			$titulos2=array();
			$gramos=array();
			...
			{
				if ($datos[$contador]["referencia"]==$datos[$contador2]["referencia"])
				{
		...
		//SE IMPRIME LOS DATOS		
				...
				if ($contador+1==count($datos)||$datos[$contador]["referencia"]!=$datos[$contador+1]["referencia"])
				{
					//$numEnviosTotal=0;
					//$numEnviosAcuseTotal=0;
