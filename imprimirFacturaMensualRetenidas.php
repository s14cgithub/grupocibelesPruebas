...
if(isset($_POST["imprimirAccion"])&$_POST["imprimirAccion"]=="imprimirMensuales")
{
	...
	$numFacturaInicio = $_POST["numFacInicioRet"];	
	$numFacturaFin = $_POST["numFacFinRet"];
	
	
	$datosFactura = verRangoFacturasPorNumeroYCdRetenidas($conexion,$numFacturaInicio, $numFacturaFin);
