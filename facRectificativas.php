...
session_start(); 
$_SESSION['titulo']="FACTURAS RECTIFICATIVAS POR DIFERENCIA";
$ruta="/";
...
<script  src="js/js_facRectificativas.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>
