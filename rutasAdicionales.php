...
session_start(); 
$_SESSION['titulo']="RUTAS ADICIONALES";
$ruta="/";
				...
				<tr>
					<td align="center">
						...
						<select name="orden" id="orden">
							...
							<option value="fecha"><?php echo "fecha" ?></option>
							<option value="hora"><?php echo "hora" ?></option>
							<option value="ruta"><?php echo "ruta" ?></option>
						...
						<input type="submit" class="btn btn-info" onClick="cargarRutasAdicionales();" value="Buscar" ></input>
				...
				if ($_SESSION["permiso_rutas"]==2)
				{
					...
					<td>
						...
						<table style="text-align: center">
							<!--<tr>
								<td><input class="" type="date" id="fecha" name="fecha" value=""></input></td>
								<td></td>
							...
							<tr>
								...
								<td><input class="" type="date" id="fecha" name="fecha" value="'; echo date("Y-m-d");echo'"></input></td>
								<td><input class="" type="time" id="hora" name="hora"></input> </td>
								<td><select id="ruta" name="ruta"  class=""></select></td>
								
								<!--<td><select id="LR" name="LR"  class="tamanio2"></select></td>
								<td><input class="tamanio2" type="time" id="LH" name="LH"></input> </td>								
								<td><select id="MR" name="MR" class="tamanio2"></select></td>
								<td><input class="tamanio2" type="time" id="MH" name="MH"></input> </td>								
								<td><select id="XR" name="XR" class="tamanio2"></select></td>
								<td><input class="tamanio2" type="time" id="XH" name="XH"></input> </td>								
								<td><select id="JR" name="JR" class="tamanio2"></select></td>
								<td><input class="tamanio2" type="time" id="JH" name="JH"></input> </td>								
								<td><select id="VR" name="VR" class="tamanio2"></select></td>
								...
								<td><input type="image" value="" src="imagenes/crear.png" style="width:20px; cursor:pointer;" onclick="insertarRutaAdicional()" ></td>
							</tr>
						</table>
	...
	<tr>
		<td>
			...
			<table border="1" align="center">
				<tbody id="RutasAdicionales" name="RutasAdicionales"></tbody>
			</table>
		</td>
	</tr>	
</table>
...
<script  src="js/js_rutasAdicionales.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>
