delete [gestionGrupoCibeles].[dbo].[facturasCorreos2019]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasCorreos2019]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CB1_19]...[CO_MAESTRO FACTURAS CORREOS] order by numero