delete [gestionGrupoCibeles].[dbo].[facturas2020]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturas2020]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CB1_20]...[C_Facturas de Contabilidad] order by numero