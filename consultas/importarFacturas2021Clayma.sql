delete [gestionGrupoCibeles].[dbo].[facturasClayma2021]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasClayma2021]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CLAYMA_21]...[C_Facturas de Contabilidad] order by numero