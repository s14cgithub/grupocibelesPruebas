delete [gestionGrupoCibeles].[dbo].[facturasCorreos2021]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasCorreos2021]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CB1_21]...[CO_MAESTRO FACTURAS CORREOS] order by numero