delete [gestionGrupoCibeles].[dbo].[facturas2019]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturas2019]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CB1_19]...[C_Facturas de Contabilidad] order by numero