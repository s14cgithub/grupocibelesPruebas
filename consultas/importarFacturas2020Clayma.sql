delete [gestionGrupoCibeles].[dbo].[facturasClayma2020]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasClayma2020]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CLAYMA_20]...[C_Facturas de Contabilidad] order by numero