delete [gestionGrupoCibeles].[dbo].[facturasCorreos2018]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasCorreos2018]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CB1_18]...[CO_MAESTRO FACTURAS CORREOS] order by numero