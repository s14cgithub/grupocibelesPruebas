delete [gestionGrupoCibeles].[dbo].[facturasClayma2018]

INSERT INTO [gestionGrupoCibeles].[dbo].[facturasClayma2018]
           ([numero]
           ,[cliente]
           ,[ot]
           ,[aPagar]
...
from [ACCESS_CLAYMA_18]...[C_Facturas de Contabilidad] order by numero