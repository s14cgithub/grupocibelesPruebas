...
if(isset($_POST["imprimirAccion"]) && $_POST["imprimirAccion"]=="imprimirFacturaRecClayma")
{
	$ruta = '/';
	...
	$numeroCompletoFacRec = isset($_POST["imprimirNumFacturaRecClayma"]) ? $_POST["imprimirNumFacturaRecClayma"] : 0;
	...
	if($tipoFactura =="SUST")	
	{
		...
		$datosFactura = verFacturaRectificativaSustitucionClayma($conexion,$numeroCompletoFacRec,$anioSeleccionado);	
		$datosDetalles = verFacturaRecSustDetalleClayma($conexion,$numeroCompletoFacRec,$anioSeleccionado);
		
	}
	else
	{
		$tituloFac = "Factura Rectificativa por Diferencia";
		$datosFactura = verFacturaRectificativaClayma($conexion,$numeroCompletoFacRec,$anioSeleccionado);	
		$datosDetalles = verFacturaRecDetalleClayma($conexion,$numeroCompletoFacRec,$anioSeleccionado);
	}	
...
Cibeles Mailing S.A. A-81339186"),0,'C',false);*/
	...
	*/
	...
	{ 
		...
		$verifactu_qrDataUrl = "https://prewww2.aeat.es/wlpl/TIKE-CONT/ValidarQR?" . http_build_query($params);	
