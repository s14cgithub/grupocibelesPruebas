...
if(isset($_POST["imprimirAccion"]) && $_POST["imprimirAccion"]=="imprimirFranqueo")
{
	...
	$idCliente = $_POST["imprimirClienteInformeDigitalClaymaFranqueoModal"];	
	$fechaInicio = $_POST["imprimirFechaInicioInformeDigitalClaymaFranqueoModal"];	
	$fechaFin = $_POST["imprimirFechaFinInformeDigitalClaymaFranqueoModal"];	
	$saldo = $_POST["imprimirSaldoFinInformeDigitalClaymaFranqueoModal"];	
	$cliente2 = $_POST["imprimirCliente2InformeDigitalClaymaFranqueoModal"];	
	$extension = $_POST["imprimirExtensionInformeDigitalClaymaFranqueoModal"];	
	...
	if (count($datosFranqueo)>0)
	{
		...
		{		
			...
			if (trim($datosFranqueo[$contador]["descripcion"]) != $descripcion)
			{
				...
				if ($descripcion=="PUBLICORREO OPTIMO ZONA A - PENINSULA - CAPITALES")
				{
					$descripcion = "PUBLICORREO OPTIMO ZONA A - PENINSULA - CAP.";
				}
