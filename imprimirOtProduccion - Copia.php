...
function imprimirDatos(&$pdf,$tipo, $row)
{
	...
	global $margen;
			...
			imprimirDetalles($pdf,$tipo,$altura,$row,$datosDetalles,$limiteAlturaDatos,$margen,$alturaSiguientePagina,$mostrarPrecio,$numPagina);
...
function imprimirDetalles(&$pdf,$tipo, &$altura, $departamento, $datosDetalles, $limiteAlturaDatos, $margen, $alturaSiguientePagina, $mostrarPrecio, &$numPagina)
{
