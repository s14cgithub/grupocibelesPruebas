...
session_start(); 
$_SESSION['titulo']= "COMPRAS A TERCEROS - LISTADO";
$ruta="/";
	...
	<tr>
		<td align="center" colspan="">Buscar por:
			<select class=""  id="buscarCampo" name="buscarCampo">					
				<option value="t4.descripcion">Concepto</option>
	...
	Orden:
		...
		<td align="left" colspan="3">
			...
			<select class="" id="ordenBuscar">					
				<option value="t1.pedido" selected>Pedido</option><!--IMPORTANTE: no añadir mas opciones-->
...
<script  src="js/js_comprasTercerosContabilidad.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>
