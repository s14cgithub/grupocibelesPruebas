...
session_start(); 
$_SESSION['titulo']="HORAS REALIZADAS POR CADA EMPLEADO";
$ruta="/";
...
<table class="d-none d-print-block sinBordesMargenPaddin" style="width: 100%">
	...
	<tr style="width: 100%">
		...
		<td align="center" style="width: 100%" class="sinBordesMargenPaddin"><h2  style="color: black" class="sinBordesMargenPaddin">Informe de Empleados</h2></td>
	</tr>
	<!--<tr>
...
<form align="center"  class="d-print-none" >
		...
		<input type="button"  class="btn btn-info" value="Buscar" onClick="cargarInformePorDia()"></input>
...
<script  src="js/js_informeProd_horasEmpleados.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>
