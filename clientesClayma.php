...
session_start(); 
$_SESSION['titulo']="Clientes Clayma";
$ruta="/";
...
if ($_SESSION["usuario"]!="")
{
	...
	$clientes = cargarClientesClayma($conexion);
...
<table align="center">
	...
	<tr>
		<td align="center" colspan="6">Buscar por:
			<select class=""  id="buscarCampo" name="buscarCampo">
				...
				<option value="subcliente">Nombre Empresa</option>
				<option value="nombre_franqueo">Nombre Franqueo</option>
				<option value="direccion">direccion</option>
				<option value="nif_subcliente">Nif</option>				
		...
		<button type="button" class="btn btn-info" onClick="cargarClientesBuscador()">BUSCAR</button></td>
	...
	<tbody id="grupoCamposSubClientes" bgcolor=""> 
		<tr>
			...
			<td><input class="" type="text" id="cliente_NifSubCliente" name="cliente_NifSubCliente" recreaadonly></input></td>
		</tr>
	</tbody>
	<tr>
	...
	<tr>
		...
		<td align="right">IBAN:<input class="" type="text"  id="numCuenta2" name="numCuenta2"  style="width: 40px;" value="ES" readonly></input></td>
	...
	<tr>
		...
		<td colspan="3"><select class=""  id="formaPago" name="formaPago" <?php echo $soloLectura; ?>></select></td>
		<td align="right">Sin Iva:</td>
		<td><input align="right" class="" type="checkbox" id="cliente_sinIva" name="cliente_sinIva"></input></td>	
	</tr>
...
<tr>
		<td colspan="6" align="center">		
			<button type="button" class="btn btn-outline-dark">DATOS DE FACTURACION CORREO DIARIO</button>
		</td>
	</tr>
...
<!------------------------------------------------------------------------------>
	...
	<tr>
		<td colspan="6" align="center">		
			<button type="button" class="btn btn-outline-dark">DIRECCION DE ENVIO</button>
		</td>
	</tr>
	...
	<tbody id="grupoContactos" bgcolor="">
		<tr>
			<td colspan="6" align="center">		
				<button type="button" class="btn btn-outline-dark" id="botonClientesContactos" onClick="cargarClientesContactosGestion()">CONTACTOS - Mostrar</button>
			</td>
		</tr>
	...
	<tbody id="grupoObservaciones" bgcolor="">
		<tr>
			<td colspan="6" align="center">		
				<button type="button" class="btn btn-outline-dark" id="botonObservaciones" onClick="observacionesClienteGestion()">OBSERVACIONES - Mostrar</button>
			</td>
		</tr>
	...
	<tbody id="grupoRegistros" bgcolor="">
...
<script type="text/javascript"> 
	...
	{	
		...
		document.getElementById("buscarTexto").value = params.get("codigo");
	...
	/*document.getElementById('numCuenta').addEventListener('input', function (e) {
