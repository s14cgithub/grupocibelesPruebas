...
if(isset($_POST["accion"])&$_POST["accion"]=="verDatosPresupuestosCombinados")
{
	...
	$resultado1 = insertarFactura($conexion, 'Comb: '.$presupuestos, $cliente, $fecha, $pedidoCliente, $cantidad, $formaPago,$numCuenta, $campana, $detallada, $baseImponible, $iva, $total, $provisionDeFondo, $aPagar, $inicialComercial,$combinadoSumatorio);
	...
	if(strpos( $resultado1, "Error" ) === 0 or count($resultado1)>0)
	{
		...
		{
			$resultado4 = copiarTemporalPreFacturaAFacturaDetalle($conexion,$numFactura,$presupuestos2[$contador],$idEmpleado,1);
