...
if(isset($_POST["accion"]) && $_POST["accion"]=="modificarRecDiferenciasPendientes")
{
	session_start(); 
	$ruta = '../';	
	...
	if ($clayma=="true")
	{
		$resultado = modificarRecDiferenciasPendientesClayma($conexion, $numFactura, $formaPago,$anioSeleccionado);
		$clayma1=1;
	}
	else
	{
		$resultado = modificarRecDiferenciasPendientes($conexion, $numFactura, $formaPago,$anioSeleccionado);
	}
