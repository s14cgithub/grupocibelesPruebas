...
if(isset($_POST["accion"]) && $_POST["accion"]=="mostrarRutasVinculaciones")
{
	session_start();
	$ruta = '../';
	...
	$resultado = mostrarRutasVinculaciones($conn, $bbddSql, $campos, $joins, $filtros, $filtrosOperadores, $order);
