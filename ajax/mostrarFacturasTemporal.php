...
if(isset($_POST["accion"]) && $_POST["accion"]=="mostrarFacturasTemporal")
{
	session_start();
	$ruta = '../';
	...
	{
		$filtros['usuario'] = $_SESSION["idEmpleado"];
	}
	...
	$resultado = mostrarFacturasTemporal($conn, $bbddSql, $campos, $filtros, $filtrosOperadores, $order, $joins);
