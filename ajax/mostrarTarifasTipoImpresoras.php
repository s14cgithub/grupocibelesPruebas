...
if(isset($_POST["accion"]) && $_POST["accion"]=="mostrarTarifasTipoImpresora")
{
	session_start();
	$ruta = '../';
	...
	$resultado = mostrarTarifasTipoImpresora($conn, $bbddSql, $campos, $filtros, $filtrosOperadores, $order);
