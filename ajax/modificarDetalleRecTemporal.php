...
if(isset($_POST["accion"])&$_POST["accion"]=="modificarDetallePrefactura")
{
	...
	$resultado = cargarUnDetalleRecTemporal($conexion,$idDetalle);
	...
	echo modificarDetalleRecTemporal($conexion,$idDetalle,$proceso,$descripcion,$nota,$unidad,$precio,$total,$exentoIVA);
