...
if(isset($_POST["accion"]) && $_POST["accion"]=="modificarClienteDireccionRutas")
{
	...
	modificarClientesDirecRutas($conn, $bbddSql, $datos1, $filtros1, $filtrosOperadores);

	$filtros2["id"] = $filtros["id"];	
	$filtrosOperadores2 = array();

	$res = modificarClientesDirecRutas($conn, $bbddSql, $datos, $filtros2, $filtrosOperadores2);
