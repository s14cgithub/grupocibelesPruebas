...
if(isset($_POST["accion"])&$_POST["accion"]=="cargarRegistrosHoras")
{
	...
	{
		$condicion = "where (t1.".registroHora_columnaHoraInicio. " >= '".$fechaInicio1."' and t1.".registroHora_columnaHoraInicio. " < '".date("d-m-Y",strtotime($fechaFin1."+ 1 days"))."' or t1.codigoBarras='0-9999999')";
	}
	else if ($fechaInicio!="" and $fechaFin!="")
	{
		$condicion = $condicion." and (t1.".registroHora_columnaHoraInicio. " >= '".$fechaInicio1."' and t1.".registroHora_columnaHoraInicio. " < '".date("d-m-Y",strtotime($fechaFin1."+ 1 days"))."' or t1.codigoBarras='0-9999999')";
	}
	else if ($fechaInicio!="" and $condicion=="") 
	{		
		$condicion = "where (t1.".registroHora_columnaHoraInicio. " >= '".$fechaInicio1."' or t1.codigoBarras='0-9999999')";
	}
	else if ($fechaInicio!="" )
	{
		$condicion  = $condicion." and (t1.".registroHora_columnaHoraInicio. " >= '".$fechaInicio1."' or t1.codigoBarras='0-9999999')";
	}

	if ($condicion!="")
	{
		$condicion  = $condicion. " and idImpresoras is not null";
	}
	else
	{
		$condicion = " where idImpresoras is not null ";
	}
