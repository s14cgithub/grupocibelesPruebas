...
if(isset($_POST["accion"]) && $_POST["accion"]=="cargarFacturacion")
{
	session_start();
	$ruta = '../';
	...
	$cargarFacturacionClayma = mostrarFacturacionClayma($conn,$bbddSql, $campos, $joins, $filtros,$filtrosOperadores, $order);

	sqlsrv_close($conn);

	echo json_encode($cargarFacturacionClayma);
