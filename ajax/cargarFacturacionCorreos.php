...
if(isset($_POST["accion"]) && $_POST["accion"]=="cargarFacturacionCorreos")
{
	session_start();
	$ruta = '../';
	...
	$cargarFacturacionCorreos = mostrarFacturacionCorreos($conn,$bbddSql, $campos, $joins, $filtros,$filtrosOperadores, $order);

	sqlsrv_close($conn);

	echo json_encode($cargarFacturacionCorreos);
