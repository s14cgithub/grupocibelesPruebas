...
//if(isset($_GET["imprimirAccion"])&$_GET["imprimirAccion"]=="imprimirPresu")
{
	...
	$numPresupuesto = $_POST["imprimirProvisionFondoNumPresupuestoClayma"];
	$numPresupuestoContador = $_POST["imprimirProvisionFondoContadorClayma"];	
