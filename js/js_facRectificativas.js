...
{	
	...
	{							
		...
		peticionUnica1.open("POST","ajax/mostrarFacRectificativa.php",false);
		...
		if(peticionUnica1.status == 200)
		{
			...
			{				
				...
				contenido += '<tr class="centrarTexto tablaCabeceraColor">';
					...
					contenido += '<th ondblclick="comprobarVerifactu(\'RectDiferencias\');">Factura</th>';
				...
				{  
					...
					{
						fondo = 'style="animation: fondoAlerta 0.4s infinite;" title="No Procesado con Verifactu"';
					}
...
{
	if (confirm("COMPROBAR FACTURAS REC. POR DIFERENCIAS SIN VERIFACTU"+document.getElementById("anio").value+"\nSolo se comprobará el año seleccionado\n¿Quieres continuar?")) 
	{    
		peticionUnica1=crearComunicacion(peticionUnica1);
