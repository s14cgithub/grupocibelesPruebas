...
function modificarPresupuesto3()//js_presupuestosListado
{
	...
	else
	{
		...
		if(peticionUnica0)
		{							
			peticionUnica0.onreadystatechange = mostrarModificarPresupuesto3;
			peticionUnica0.open("POST","ajax/modificarPresupuesto3.php",false);
			peticionUnica0.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");		
...
{	
	var consulta = "accion=modificarRegistro3";
	
	consulta+="&numPresupuesto="+document.getElementById("numPresuModal").innerHTML;
	...
	else
	{
		...
		consulta+="&fechaAceptacion=" + diaFin + "/" + mesFin + "/" + anioFin;
	...
	else
	{
		...
		consulta+="&fechaCompromiso=" + diaFin + "/" + mesFin + "/" + anioFin;	
	}
	
	//alert(consulta);
	//alert(document.getElementById(presupuesto1+"_fechaRealizada").value);
	return consulta;	
}
