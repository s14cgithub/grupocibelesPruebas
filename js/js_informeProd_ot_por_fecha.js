...
function cargarInformePorFecha()
{
...
function cargarInformePorDia2()
{
	...
	{							
		...
		peticionUnica1.open("POST","ajax/produccion_verInformePorOtPorFecha.php",false);
			...
			else
			{
				...
				else
				{
					...
					while  (contador<datos.length)
					{
						...
						contenido += '<tr><td '+contraste+'>'+datos[contador]["presupuesto"]+'</td>';
						contenido += '<td '+contraste+'>'+datos[contador]["minutosTrabajados"]+'</td>';
						contenido += '<td '+contraste+'>'+datos[contador]["finalizado"]+'</td>';
						contenido += '<td '+contraste+'>'+datos[contador]["cantidad2"]+'</td>';
						contenido += '<td '+contraste+'>'+datos[contador]["cantidadRealizada"]+'</td>';
						contenido += '<td '+contraste+' align="right">'+datos[contador]["tantoPorcientoRealizado"]+' %</td>';
						contenido += '</tr>';
						contador++;
...
function cargarInformePorDiaTotal()
{
	...
	{							
		...
		peticionUnica1.open("POST","ajax/produccion_verInformePorOtPorFechaTotal.php",false);
		peticionUnica1.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");		
		...
		if(peticionUnica1.status == 200)
		{
			...
			else
			{
				...
				else
				{
					...
					contenido += '<tr'+contraste+'><td '+contraste+'><b>TOTAL</b></td>';
					contenido += '<td '+contraste+'><b>'+Number(datos[0]["minutosTrabajados"]).toLocaleString('de-DE',{minimumFractionDigits: 2})+'</b></td>';
					contenido += '<td></td>';
					contenido += '<td '+contraste+'><b>'+ Number(datos[0]["cantidad2"]).toLocaleString('de-DE',{minimumFractionDigits: 2}) +'</b></td>';
					contenido += '<td '+contraste+' ><b>'+ Number(datos[0]["cantidadRealizada"]).toLocaleString('de-DE',{minimumFractionDigits: 2}) +'</b></td>';
					contenido += '<td '+contraste+' align="right"><b>'+ Number(datos[0]["tantoPorcientoRealizado"]).toLocaleString('de-DE',{minimumFractionDigits: 0}) +' %</b></td>';
					contenido += '</tr>';
