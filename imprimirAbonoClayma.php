...
if(isset($_POST["imprimirAccion"]) && $_POST["imprimirAccion"]=="imprimirAbonoClayma")
{
	$ruta = '/';
	...
	$numFactura = $_POST["imprimirNumFacturaAbonoClayma"];	
	$anioSeleccionadoClayma = $_POST["imprimirAnioSeleccionadoClayma"];
	
	$datosFactura = verAbonoClayma($conexion,$numFactura,$anioSeleccionadoClayma);
	$datosDetalles = verAbonoDetalleClayma($conexion,$datosFactura[0]["numero"],$anioSeleccionadoClayma);
