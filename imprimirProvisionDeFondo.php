...
//if(isset($_GET["imprimirAccion"])&$_GET["imprimirAccion"]=="imprimirPresu")
{
	...
	$numPresupuesto = $_POST["imprimirProvisionFondoNumPresupuesto"];
	$numPresupuestoContador = $_POST["imprimirProvisionFondoContador"];	
	...
	//echo  mostrarProvisionDeFondos2($conexion,$numPresupuesto,$numPresupuestoContador);
	...
	$pdf->Cell(35,5,utf8_decode("Nº PROVISION"),1,1,'C',false);
	$altura = $altura + 5;
	$pdf->SetXY($margen+155,$altura);
	$pdf->SetFont('Arial','B',10);
	...
	$altura = $altura + 8;
	$pdf->SetXY($margen+155,$altura);
	//echo $datosProvisionFondo["datos"][0]["fechaCreacion"];
	...
	$pdf->Cell(0,0,"PROVISION DE FONDOS",0,1,'C',false);
	...
	$altura = $altura + 15;	
	$pdf->SetXY($margen+8,$altura);	
	$pdf->MultiCell(0,5,utf8_decode("BBVA: ES12 0182 1291 8102 0850 5504 BIC:BBVAESMMXXX"),0,'L',false);
	...
	$pdf->SetXY($margen+8,$altura);	
	$pdf->MultiCell(0,5,utf8_decode("Talón nominativo a Cibeles Mailing S.A."),0,'L',false);
