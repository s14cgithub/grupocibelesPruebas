					...
					<td>
						...
						<table style="text-align: center">
							...
							<tr>
								...
								<td><select name="RN_Impresora" id="RN_Impresora"></select></td>
								...
								<td><select name="RN_Origen" id="RN_Origen"></select></td>
								<td><select name="RN_NumCaras" id="RN_NumCaras"><option value="0">0</option><option value="1">1</option><option value="2">2</option></select></td>
	...
	<div class="modal-dialog" role="document">
    	<div class="modal-content">
      		...
      		<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" data-dismiss="" onClick="modificarRegistroTrabajo()">Modificar</button>
...
<!--proceso manuales NUEVO-->

<div class="modal fade" id="modalRegistroManualSinProceso_nuevo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
    	<div class="modal-content" style="width: 150% !important;">
      		<div class="modal-header">       
		  		<h5 class="modal-title" id="ModalLabel2">REGISTRO <span id="registroProcesoModal2"></span></h5>
      		</div>
      		<div class="modal-body">
        		<form>		
					<table>
						...
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Proceso:</label></td>
							<td><select id="procesoModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Cliente:</label></td>
							<td><select id="clienteModal2" class="form-control" style="color:black;"></select></td>
						</tr>
						<hr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Impresora:</label></td>
							<td><select id="impresoraModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Tamaño:</label></td>
							<td><select id="tamanoModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Tipo:</label></td>
							<td><select id="tipoModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Acabado:</label></td>
							<td><select id="acabadoModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Gramaje:</label></td>
							<td><select id="gramajeModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Origen:</label></td>
							<td><select id="origenModal2" class="form-control"></select></td>
						</tr>
						<tr>
							<td><label for="recipient-name" class="" style="color:black;">Nº Caras:</label></td>
							<td><select id="numCarasModal2" class="form-control"><option value="0">0</option><option value="1">1</option><option value="2">2</option></select></td>
						</tr>
...
<script  src="js/js_registrosHorasManuales.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>

<script language="javascript">

	cargarImpresoras("RN_Impresora");
	...
	cargarTamanios("tamanoModal2");
	cargarTipos("tipoModal2");
	cargarAcabado("acabadoModal2");
	cargarGramaje("gramajeModal2");
	cargarOrigen("origenModal2");
