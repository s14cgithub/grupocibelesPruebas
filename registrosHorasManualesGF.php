...
session_start(); 
$_SESSION['titulo']="REGISTROS GRAN FORMATO";
$ruta="/";
					...
					<td>
						...
						<table style="text-align: center">
							...
							<tr>								
								...
								<td><select name="RN_concepto" id="RN_concepto" onchange="cargarSubConcepto1('RN_subconcepto1');"></select></td>
								<td><select name="RN_subconcepto1" id="RN_subconcepto1" onchange="cargarSubConcepto2('RN_subconcepto2');"></select></td>
								<td><select name="RN_subconcepto2" id="RN_subconcepto2"></select></td>
...
<script  src="js/js_registrosHorasManualesGF.js?<?php echo (versionCibeles); ?>" type="text/javascript" language="JavaScript" charset="UTF-8"></script>

<script language="javascript">

	cargarConcepto("RN_concepto");
