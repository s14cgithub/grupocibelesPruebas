...
if(isset($_POST["previsualizarAccion"]) && $_POST["previsualizarAccion"]=="previsualizarFactura")
{
	...
	//$datosFactura = verFacturaClayma($conexion,$numFactura);
	$numPresupuesto = $_POST["previsualizar_presupuesto"];
	...
	$pdf->Cell(0,5,"Cod. Cliente: ".$idCliente.$retener,0,1,'R',false);
...
Cibeles Mailing S.A. A-81339186"),0,'C',false);*/
	...
	$pdf->Output("I","Previsualizacion Factura Cibeles - ".$numPresupuesto."-".date("dmy")." .pdf","UTF-8");
